          ...
          <div class="col-12 col-sm-6 col-md-4">
            <div class="small-box bg-light shadow-sm border">
              ...
              <div class="icon">
                ...
                <i class="fa fa-building" style="color: #696969;"></i>
              </div>
            </div>
          </div>
           <div class="col-12 col-sm-6 col-md-4">
            <div class="small-box bg-light shadow-sm border">
              ...
              <div class="icon">
                <i class="fa fa-list-alt" style="color: #696969;"></i>
              </div>
            </div>
          </div>
           <div class="col-12 col-sm-6 col-md-4">
            <div class="small-box bg-light shadow-sm border">
              ...
              <div class="icon">
                <i class="fa fa-users" style="color: #696969;"></i>
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-md-4">
            <div class="small-box bg-light shadow-sm border">
              ...
              <div class="icon">
                <i class="fa fa-user-friends" style="color: #696969;"></i>
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-md-4">
            <div class="small-box bg-light shadow-sm border">
              ...
              <div class="icon">
                <i class="fa fa-user-secret" style="color: #696969;"></i>
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-md-4">
            <div class="small-box bg-light shadow-sm border">
              ...
              <div class="icon">
                <i class="fa fa-tasks" style="color: #696969;"></i>
              </div>
            </div>
          </div>
      </div>
